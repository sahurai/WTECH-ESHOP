        ...
        <div class="flex flex-row items-center">
            <div class="flex items-center space-x-4">
                <label class="inline-flex items-center text-blue">
                    <input type="radio" name="sort" value="newest" class="form-radio text-dark-red"
                        onchange="this.form.submit()" {{ request('sort') === 'newest' ? 'checked' : '' }}>
                    <span class="ml-2">Newest</span>
                </label>
                <label class="inline-flex items-center text-blue">
                    <input type="radio" name="sort" value="oldest" class="form-radio text-dark-red"
                ...
                <label class="inline-flex items-center text-blue">
                    <input type="radio" name="sort" value="title_asc" class="form-radio text-dark-red"
                        ...
                        {{ request('sort') === 'title_asc' || !request()->has('sort') ? 'checked' : '' }}>
