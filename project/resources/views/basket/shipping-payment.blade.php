...
@section('basketContent')
    <form action="{{ route('checkout.shipping.store') }}" method="POST">
        ...
        <section class="flex justify-between flex-col md:flex-row px-8 py-4 md:gap-4 gap-2">
            ...
            <section class="flex-1 space-y-2">
                ...
                <div class="space-y-2 text-sm md:text-base lg:text-lg text-blue">
                    <label
                        ...
                        <input type="radio" name="shipping" value="standard" class="form-radio accent-red-400" />
                    ...
                    <label
                        ...
                        <input type="radio" name="shipping" value="express" class="form-radio accent-red-400" />
                        <span class="text-blue">Express Shipping (2-3 days)</span>
                    </label>
                    <label
                        class="flex items-center py-3 px-4 space-x-2 hover:bg-gray-100 rounded-lg border shadow-md shadow-orange-200">
                        <input type="radio" name="shipping" value="next_day" class="form-radio accent-red-400" />
                        <span class="text-blue">Next Day Delivery</span>
                    </label>
                    <label
                        class="flex items-center py-3 px-4 space-x-2 hover:bg-gray-100 rounded-lg border shadow-md shadow-orange-200">
                        <input type="radio" name="shipping" value="another" class="form-radio accent-red-400" />
            ...
            <section class="flex-1 space-y-2">
                ...
                <div class="space-y-2 text-sm md:text-base lg:text-lg text-blue">
                    <label
                        class="flex items-center py-3 px-4 space-x-2 hover:bg-gray-100 rounded-lg border shadow-md shadow-orange-200">
                        <input type="radio" name="payment" value="debit_card" class="form-radio accent-red-400" />
                        <span class="text-blue">Debit card</span>
                    </label>
                    <label
                        class="flex items-center py-3 px-4 space-x-2 hover:bg-gray-100 rounded-lg border shadow-md shadow-orange-200">
                        <input type="radio" name="payment" value="paypal" class="form-radio accent-red-400" />
                        <span class="text-blue">PayPal</span>
                    </label>
                    <label
                        class="flex items-center py-3 px-4 space-x-2 hover:bg-gray-100 rounded-lg border shadow-md shadow-orange-200">
                        <input type="radio" name="payment" value="google_pay" class="form-radio accent-red-400" />
        ...
        @include('basket.partials.order-buttons', ['step' => 2])
    </form>
@endsection
